...
function PressKit() {
  return (
    <div className="bg-zinc-900 flex flex-col items-center justify-center">
      <Link to="https://www.dropbox.com/sh/25jx5nf978g0y98/AAANw43pURaId8k1o4U8GxvPa?dl=0">
        <h2 className="text-white font-custom text-2xl underline w-full text-center m-5">
          Presskit
        </h2>
      </Link>
