...
function Instagram() {
  ...
  return (
    <div className="bg-stone-950 w-full h-150 flex justify-center flex-wrap">
...
//           {" "}
//           <a
//             href="https://www.instagram.com/p/ChBNDvvFWD-/?utm_source=ig_embed&amp;utm_campaign=loading"
//             style={{
//               background: "#FFFFFF",
//               lineHeight: "0",
//               padding: "0",
...
//               target="_blank"
//             >
//               Uma publicação compartilhada por Tchéz (@listentchez)
//             </a>
//           </p>
//         </div>
//       </blockquote>
