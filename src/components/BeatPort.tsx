...
function Beatport() {
  return (
    <div className="flex flex-col flex-wrap justify-center items-center gap-8 bg-zinc-900 p-10">
      ...
      <p className='text-white bg-zinc-800 font-custom -mt-8'>Veja mais em <a className='underline' href="https://grve.com.br/2023/04/tchez-ep-lunar/">https://grve.com.br/2023/04/tchez-ep-lunar/</a></p>
    </div>
  );
}
