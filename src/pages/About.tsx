...
function About() {
  return (
    <div>
      ...
      <h1 className="text-zinc-200 text-2xl font-custom mt-10">Sobre o Artista</h1>
        <div className="flex justify-center items-center flex-col gap-10 md:w-2/4 sm:w-2/4 w-3/4">
